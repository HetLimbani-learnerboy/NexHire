...
const MOCK_CANDIDATES = [
  { id: 1, name: "Aditya Patel", email: "aditya@gmail.com", job: "Senior React Developer", vendor: "TechStaff Solutions", status: "Interview", resume: true, date: "2026-04-20" },
  { id: 2, name: "Sneha Sharma", email: "sneha.s@gmail.com", job: "Full Stack Developer", vendor: "InnoRecruit Pvt Ltd", status: "Screened", resume: true, date: "2026-04-19" },
  { id: 3, name: "Ravi Verma", email: "ravi.v@yahoo.com", job: "DevOps Engineer", vendor: "CloudHire Global", status: "Submitted", resume: true, date: "2026-04-22" },
  { id: 4, name: "Neha Gupta", email: "neha.g@outlook.com", job: "Data Analyst", vendor: "SkillBridge HR", status: "Rejected", resume: true, date: "2026-04-15" },
  { id: 5, name: "Vikram Joshi", email: "vikram.j@gmail.com", job: "Senior React Developer", vendor: "HireWave Tech", status: "Offered", resume: true, date: "2026-04-18" },
  { id: 6, name: "Priyanka Das", email: "priyanka.d@gmail.com", job: "UI/UX Designer", vendor: "RecruitEdge", status: "Interview", resume: true, date: "2026-04-21" },
  { id: 7, name: "Arjun Mehta", email: "arjun.m@gmail.com", job: "Backend Engineer (Java)", vendor: "TalentForce India", status: "Hired", resume: true, date: "2026-04-10" },
  { id: 8, name: "Kavita Singh", email: "kavita.s@gmail.com", job: "Full Stack Developer", vendor: "ProHire Solutions", status: "Screened", resume: true, date: "2026-04-23" },
  { id: 9, name: "Rohit Kumar", email: "rohit.k@gmail.com", job: "QA Automation Engineer", vendor: "TechStaff Solutions", status: "Submitted", resume: true, date: "2026-04-24" },
  { id: 10, name: "Ananya Reddy", email: "ananya.r@gmail.com", job: "Product Manager", vendor: "InnoRecruit Pvt Ltd", status: "Interview", resume: true, date: "2026-04-17" },
];
...
function Candidates() {
  ...
  const statusCounts = MOCK_CANDIDATES.reduce((acc, c) => { acc[c.status] = (acc[c.status] || 0) + 1; return acc; }, {});

  const columns = ["Candidate", "Applied For", "Vendor", "Submitted", "Resume", "Status", "Actions"];

  const renderRow = (c) => (
    <tr key={c.id}>
      <td><div className="table-user"><div className="table-user-avatar">{c.name.split(" ").map(w=>w[0]).join("")}</div><div className="table-user-info"><h4>{c.name}</h4><p>{c.email}</p></div></div></td>
      ...
      <td>{c.resume ? <span className="badge badge-info">📄 Resume</span> : <span className="badge badge-neutral">No file</span>}</td>
      <td>{getStatusBadge(c.status)}</td>
      <td><div className="table-actions"><button className="table-action-btn" title="View">👁</button><button className="table-action-btn" title="Move Stage">↗️</button><button className="table-action-btn danger" title="Reject">✕</button></div></td>
    </tr>
  );
